...
<div class="container-fluid bg-body-tertiary dark__bg-gray-1200">
                                ...
                                <div class="auth-form-box">
                                    ...
                                    <form>
                                        ...
                                        <div class="row g-3 mb-3">
                                            ...
                                            <div class="col-sm-6"><label class="form-label" for="password_confirmation">Confirm Password</label>
                                                <div class="position-relative" data-password="data-password">
                                                    <input class="form-control form-icon-input pe-6" id="password_confirmation" type="password" placeholder="Confirm Password" data-password-input="data-password-input">
                                                    <button class="btn px-3 py-0 h-100 position-absolute top-0 end-0 fs-7 text-body-tertiary" data-password-toggle="data-password-toggle">
                                                        <span class="uil uil-eye show"></span><span class="uil uil-eye-slash hide"></span>
                                                    </button>
                                                </div>
                                        ...
                                        <div class="form-check mb-3">
                                            ...
                                            <label class="form-label fs-9 text-transform-none" for="termsService">I accept the
                                                <a href="https://prium.github.io/phoenix/v1.23.0/pages/authentication/card/sign-up.html?#!">terms </a>and
                                                <a href="https://prium.github.io/phoenix/v1.23.0/pages/authentication/card/sign-up.html?#!">privacy policy</a>
                                            </label>
                                        </div>
                                        <button class="btn btn-primary w-100 mb-3" id="registerBtn">Sign up</button>
    ...
    @push('scripts')
    <script src="{{ asset('js/Auth/register_auth.js') }}"></script>
    @endpush
    @endsection